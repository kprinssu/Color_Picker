...
namespace Color_Picker
{
    public sealed class Clr_Pckr : Control
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            this.PointerExited += Clr_Pckr_PointerExited;
        ...
        private void Clr_Pckr_PointerExited(object sender, PointerRoutedEventArgs e)
        {
        ...
        private async void loadnew()
        {
            ...
            using (IRandomAccessStream fileStream = res)
            {
        ...
        private void Rectangle_PointerPressed_1(object sender, PointerRoutedEventArgs e)
        {
            ...
            Color newColor = LinearGdHelperClass.GetColorAtPoint(rectColor, new Point(x + 4, y + 4));
            FinalColor.Fill = new SolidColorBrush(newColor);
